...
deskArray.unshift(deskArray.pop());                                    // Nested method, method in bracket takes precedence
...
const foundItem = deskArray.find((item) => item === "notebook");      // Looking for identically equal item
...
let remove = "notebook";
deskArray.splice(deskArray.indexOf(remove), 1);                     // Nested method, method in bracket takes precedence
