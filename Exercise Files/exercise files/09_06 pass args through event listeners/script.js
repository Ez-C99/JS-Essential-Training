...
const backpackList = backpackObjectArray.map((backpack) => {
  ...
  // Add event listener
  button.addEventListener("click", (event) => {       // Anon function as callback function wraps around ligToggle. Call lidToggle as proper function and call whatever we want
    lidToggle(event, button, newArg)                  // Pass button element too so 'this' refers to it and avoid error
  })
